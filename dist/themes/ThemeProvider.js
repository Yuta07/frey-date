...
exports.ThemeContext = react_1.createContext(Theme_1.theme('light'));
exports.ThemeProvider = ({ theme, children }) => {
    return react_1.default.createElement(exports.ThemeContext.Provider, { value: theme }, children);
};
exports.useTheme = () => {
    const appTheme = react_1.useContext(exports.ThemeContext);
    return appTheme;
};
